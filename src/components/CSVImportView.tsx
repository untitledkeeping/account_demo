...
import { Button, Badge as MoonBadge } from '@moondesignsystem/react';
import {
  UploadCloud,
  FileSpreadsheet,
  CheckCircle2,
      ...
      <div className="bg-slate-900 text-white p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-slate-800 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            ...
            className="flex items-center space-x-1.5 !bg-slate-800 hover:!bg-slate-700 !text-white !border-slate-700"
          >
            <FileSpreadsheet className="w-3.5 h-3.5 mr-1 text-blue-400" />
        ...
        <div className="lg:col-span-7 space-y-4">
          {batchValidation.isBalanced ? (
            <div className="bg-emerald-50 border border-emerald-200/80 rounded-xl p-3 sm:p-3.5 flex items-center justify-between text-xs text-emerald-900">
              ...
              <MoonBadge context="positive" className="font-mono font-bold text-[10px]">
                Balanced
              </MoonBadge>
            </div>
          ) : (
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200/90 shadow-xs overflow-hidden">
            <div className="p-4 border-b border-slate-100 flex items-center justify-between">
              ...
              <MoonBadge context="positive" className="text-[10px] font-bold">
