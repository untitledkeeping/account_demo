    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8 space-y-6">
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1 mt-2 text-xs text-slate-600">
        ...
        {parsedResult && parsedResult.extractedEntries.length > 0 && (
          <button
            ...
            className={`flex items-center justify-center space-x-2 font-bold px-4 py-2.5 rounded-xl text-xs transition-all shadow-xs min-h-[40px] ${
      ...
      <div className="bg-slate-900 text-white p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-slate-800 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="flex items-center space-x-1.5 bg-slate-800 hover:bg-slate-700 px-3 py-2 rounded-lg text-xs font-semibold border border-slate-700 transition-colors min-h-[36px]"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-3">
          <div
            ...
            onDrop={handleDrop}
            className={`border-2 border-dashed rounded-xl sm:rounded-2xl p-5 sm:p-6 text-center transition-all cursor-pointer bg-white ${
          ...
          >
            ...
            <label htmlFor="csv-file-input" className="cursor-pointer block space-y-2">
              <UploadCloud className="w-7 h-7 sm:w-8 sm:h-8 mx-auto text-slate-400" />
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200/90 shadow-xs p-4 space-y-2">
        ...
        <div className="lg:col-span-7 space-y-4">
          {batchValidation.isBalanced ? (
            <div className="bg-emerald-50 border border-emerald-200/80 rounded-xl p-3 sm:p-3.5 flex items-center justify-between text-xs text-emerald-900">
              ...
              <span className="font-mono font-bold text-emerald-700 text-[10px] sm:text-[11px] bg-white px-2 py-0.5 rounded border border-emerald-200">
                Balanced
              </span>
            </div>
          ) : (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 sm:p-3.5 space-y-1 text-xs text-amber-900">
